...
smoke:
	...
	$(VERILATOR) --binary --sv --timing --assert -Wall -Wno-fatal --top-module tb_ahb_smoke --Mdir build/obj_ahb rtl/ahb_lite_memory_slave.sv tb/smoke/tb_ahb_smoke.sv
	./build/obj_ahb/Vtb_ahb_smoke|tee results_smoke.log
clean:
